...
if ( !function_exists( 'raiderspirit_vc_get_css' ) ) {
	add_filter( 'raiderspirit_filter_get_css', 'raiderspirit_vc_get_css', 10, 4 );
	function raiderspirit_vc_get_css($css, $colors, $fonts, $scheme='') {
