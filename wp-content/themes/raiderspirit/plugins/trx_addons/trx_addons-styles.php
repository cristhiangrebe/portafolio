...
if (!function_exists('raiderspirit_trx_addons_get_css')) {
	add_filter('raiderspirit_filter_get_css', 'raiderspirit_trx_addons_get_css', 10, 4);
	function raiderspirit_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.trx_addons_dropcap, .sc_item_subtitle,
...
.slider_outer_controls_side .slider_controls_wrap > a {
	color: {$colors['inverse_link']};
	background-color: {$colors['alter_dark_04']};
	border-color: {$colors['alter_dark_04']};
}
...
.sc_services_chess .sc_services_item_button a {
    color:{$colors['text_link']};
}
.sc_services_chess .sc_services_item_button a:hover {
    color:{$colors['bg_color']};
}
