...
if ( !function_exists( 'raiderspirit_woocommerce_get_css' ) ) {
	add_filter( 'raiderspirit_filter_get_css', 'raiderspirit_woocommerce_get_css', 10, 4 );
	function raiderspirit_woocommerce_get_css($css, $colors, $fonts, $scheme='') {
...
.add_to_cart_button, .button.product_type_grouped, .button.product_type_external {
    color: {$colors['text_light']} !important;
}
.add_to_cart_button:hover, .button.product_type_grouped:hover, .button.product_type_external:hover {
...
.woocommerce-page ul.products li.product .price del> span>span {
	color: {$colors['text_light']} !important;
}
...
/* Shop mode selector */
.raiderspirit_shop_mode_buttons a {
	color: {$colors['text_link2']};
}
.raiderspirit_shop_mode_buttons a:hover {
	color: {$colors['text_hover2']};
}
.shop_mode_thumbs .raiderspirit_shop_mode_buttons a.woocommerce_thumbs,
.shop_mode_list .raiderspirit_shop_mode_buttons a.woocommerce_list {
	color: {$colors['text_link']};
}
...
.price_slider_amount .sc_button_hover_style_link2 {
    color: {$colors['text_light']} !important;
}
.price_slider_amount .sc_button_hover_style_link2:hover {
    color: {$colors['inverse_link']} !important;
}
