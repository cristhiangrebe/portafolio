...
if (!function_exists('raiderspirit_booked_get_css')) {
	add_filter('raiderspirit_filter_get_css', 'raiderspirit_booked_get_css', 10, 4);
	function raiderspirit_booked_get_css($css, $colors, $fonts, $scheme='') {
