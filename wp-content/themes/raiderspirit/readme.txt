...
You can install it from the menu 'Appearance->Install plugins' or on the page 'Appearance->About RaiderSpirit'.
Please install and activate it before starting to use the theme RaiderSpirit.
...
Theme documentation is available on http://raider-spirit.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in RaiderSpirit is Fontello.
