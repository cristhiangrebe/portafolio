...
if (!function_exists('raiderspirit_customizer_get_css')) {

	function raiderspirit_customizer_get_css($colors=null, $fonts=null, $remove_spaces=true, $only_scheme='') {
		...
		if ($fonts) {
			...
			$fonts = raiderspirit_customizer_add_theme_fonts($fonts);
...
CSS;
			$rez = apply_filters('raiderspirit_filter_get_css', $rez, false, $fonts, '');
			$css['fonts'] = $rez['fonts'];

			
			// Border radius
			//--------------------------------------
			$rad = raiderspirit_get_border_radius();
			$rad50 = ' '.$rad != ' 0' ? '50%' : 0;
			$css['fonts'] .= <<<CSS
...
CSS;
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($only_scheme) ? array_keys(raiderspirit_get_list_schemes()) : array($only_scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $scheme) {
					// Prepare colors
					if (empty($only_scheme)) $colors = raiderspirit_get_scheme_colors($scheme);
...
header .scheme_self.sc_layouts_row_type_compact .sc_layouts_item_icon {
	color: {$colors['text_hover2']};
}
...
.raiderspirit_tabs .raiderspirit_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.raiderspirit_tabs .raiderspirit_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
.sheme_self.sidebar .raiderspirit_tabs .raiderspirit_tabs_titles li a {
	color: {$colors['alter_dark']};
	background-color: {$colors['alter_bg_hover']};
}
.sheme_self.sidebar div.esg-filter-wrapper .esg-filterbutton > span:hover,
.sheme_self.sidebar .mptt-navigation-tabs li a:hover,
.sheme_self.sidebar .raiderspirit_tabs .raiderspirit_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['alter_link']};
}
...
.sheme_self.sidebar .raiderspirit_tabs .raiderspirit_tabs_titles li.ui-state-active a {
...
.footer_wrap .wp-playlist .mejs-container .mejs-controls {
	background: {$colors['inverse_text_07']};
}
...
.mejs-controls .mejs-horizontal-volume-slider .mejs-horizontal-volume-total {
	background: {$colors['extra_bg_color_01']};
}
...
.post_item_single .post_header.entry-header .author_link,
...
.post_item_single .post_header.entry-header .author_link:hover{
	color: {$colors['text_hover2']};
}
...
.woocommerce.widget_product_search .search_field[placeholder]::-webkit-input-placeholder	{ color: {$colors['inverse_link']}; }
.woocommerce.widget_product_search .search_field[placeholder]::-moz-placeholder			{ color: {$colors['inverse_link']}; }
.woocommerce.widget_product_search .search_field[placeholder]:-ms-input-placeholder		{ color: {$colors['inverse_link']}; }
.woocommerce.widget_product_search .search_field[placeholder]::placeholder                 { color: {$colors['inverse_link']}; }
...
.vc_toggle.vc_toggle_simple .vc_toggle_title:hover h1,
.vc_toggle.vc_toggle_simple.vc_toggle_active .vc_toggle_title h1,
 .vc_toggle.vc_toggle_simple .vc_toggle_title:hover h2,
.vc_toggle.vc_toggle_simple.vc_toggle_active .vc_toggle_title h2,
.vc_toggle.vc_toggle_simple .vc_toggle_title:hover h3,
.vc_toggle.vc_toggle_simple.vc_toggle_active .vc_toggle_title h3,
.vc_toggle.vc_toggle_simple .vc_toggle_title:hover h4,
.vc_toggle.vc_toggle_simple.vc_toggle_active .vc_toggle_title h4,
.vc_toggle.vc_toggle_simple .vc_toggle_title:hover h5,
.vc_toggle.vc_toggle_simple.vc_toggle_active .vc_toggle_title h5,
.vc_toggle.vc_toggle_simple .vc_toggle_title:hover h6,
.vc_toggle.vc_toggle_simple.vc_toggle_active .vc_toggle_title h6 {
    color: {$colors['inverse_link']};
}
...
/*Titles*/
.sc_title_alter.color_style_link3 .sc_item_title:before, .sc_title_alter.color_style_link3 .sc_item_title:after {
    color: {$colors['text_link3']};
}
...
.sc_button_border:hover {
    color: {$colors['text_dark']} !important;
}

CSS;
				
					$rez = apply_filters('raiderspirit_filter_get_css', $rez, $colors, false, $scheme);
		...
		return apply_filters( 'raiderspirit_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>