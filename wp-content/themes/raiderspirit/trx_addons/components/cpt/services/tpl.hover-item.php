...
?>>
	<div class="sc_services_item_header "<?php if ($args['hide_bg_image']==0 && !empty($image)) echo ' style="background-image: url('.esc_url($image).');"'; ?>>
		<div class="sc_services_item_header_inner">
			...
			?>
			<h1 class="sc_services_item_title"><span class="icon-untitled-1"></span><a href="<?php echo esc_url($link); ?>"><?php the_title(); ?></a><span class="icon-untitled-2"></span></h1>
