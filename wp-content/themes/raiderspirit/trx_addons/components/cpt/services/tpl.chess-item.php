...
?>><?php
	...
	<div class="sc_services_item_content">
		<?php
		$title_tag = 'h6';
		if ($args['columns'] == 1) $title_tag = 'h2';
		?>
		...
		<?php } ?>
	<div class="sc_services_item_button sc_item_button"><a href="<?php echo esc_url($link); ?>" class="<?php echo esc_attr(apply_filters('trx_addons_filter_sc_item_link_classes', 'service_btn_simple', 'sc_services', $args)); ?>"><?php esc_html_e('View more', 'raiderspirit'); ?></a></div>
	</div>
</div>
<?php
