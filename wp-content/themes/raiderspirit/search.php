...
// Search page setup
// (uncomment lines with raiderspirit_storage_set_array2() calls if you want to override the relevant settings from Theme Options)
...
raiderspirit_storage_set_array2('options', 'blog_style', 'val', 'masonry_3');

// Sidebar position:
// Replace last parameter with one of values: none | left | right
raiderspirit_storage_set_array2('options', 'sidebar_position_blog', 'val', 'none');
